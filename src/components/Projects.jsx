    ...
    return (
        <>
            ...
            <p className="cmd-output text-yellow">
                <li>A Discord Bot, to help you get through though time, named LifeHelpElm!<span className="text-blue font-bold">(Private Bot, hit me on discord (fasterelm) if you want to try it!)</span></li>
